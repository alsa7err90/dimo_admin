...
@section('content')
    @push('button')
        <a href="{{ route('admin.posts.create') }}" class="{{ Style::BTN_DEFAULT }}"> @lang('New Post')</a>
    @endpush
    ...
    <div class="overflow-x-auto w-full">
                ...
                @foreach ($posts as $key => $post)
                    <tr id="user_{{ $post->id }}">
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.posts.edit', $post->id) }}" class="{{ Style::BTN_SHOW }}">
                                @lang('Edit')</a>
     ...
     @include('post::admin.form_delete')
    @endsection
